...
export class VitalSignsProcessor {
  ...
  private readonly PERFUSION_INDEX_THRESHOLD = 0.02; // Lowered threshold for greater sensitivity
  private readonly SPO2_WINDOW = 4; // Shortened for faster initial response
  private readonly SMA_WINDOW = 3;
  private readonly RR_WINDOW_SIZE = 6; // Increased window size for better accuracy
  private readonly RMSSD_THRESHOLD = 15; // Lowered for better arrhythmia detection
  private readonly ARRHYTHMIA_LEARNING_PERIOD = 1000; // Shortened learning period
  private readonly PEAK_THRESHOLD = 0.2; // Lowered for greater sensitivity
