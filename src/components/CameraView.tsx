...
const CameraView = ({ 
  ...
  // Additional log to verify the signal quality being received
  useEffect(() => {
    if (isMonitoring) {
      console.log("CameraView: Received signal quality:", signalQuality);
      console.log("CameraView: Finger detected status:", isFingerDetected);
    }
  }, [signalQuality, isFingerDetected, isMonitoring]);
