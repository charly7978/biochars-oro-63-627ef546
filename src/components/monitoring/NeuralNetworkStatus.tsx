...
import tensorFlowModelRegistry, { TensorFlowModel } from '../../core/neural/tensorflow/TensorFlowModelRegistry';
...
export function NeuralNetworkStatus({
  enabled,
  ready,
  models = tensorFlowModelRegistry.getAllModels(),
  ...
  return (
    <Card className="shadow-sm">
      <CardHeader className="pb-2">
        ...
        <CardDescription>
          {ready 
            ? "TensorFlow.js models ready for processing" 
            : "Initializing models..."}
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        {models.length === 0 && (
          <div className="text-center py-6 text-muted-foreground">
            ...
            <p>No models available currently</p>
          </div>
        )}
      </CardContent>
    </Card>
