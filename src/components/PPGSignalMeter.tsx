...
const PPGSignalMeter = memo(({ 
  ...
  const USE_OFFSCREEN_CANVAS = false; // Desactivado completamente para evitar problemas de tipado
  ...
  useEffect(() => {
    ...
    // Desactivado para evitar problemas de tipado con OffscreenCanvas
