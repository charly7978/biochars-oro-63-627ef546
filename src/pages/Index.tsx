...
const Index = () => {
  ...
  return (
    ...
    <div className="fixed inset-0 flex flex-col bg-white" style={{ 
      height: '100vh',
      width: '100vw',
      maxWidth: '100vw',
      maxHeight: '100vh',
      ...
      <div className="flex-1 relative">
        ...
        <div className="relative z-10 h-full flex flex-col">
          <div className="px-4 py-2 flex justify-around items-center bg-white/60">
          ...
          <div className="absolute inset-x-0 top-[45%] bottom-[60px] bg-white/80 px-4 py-6">
