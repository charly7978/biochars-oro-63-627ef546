        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="absolute inset-x-0 top-[45%] bottom-[60px] bg-black/10 px-4 py-6">
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 place-items-center h-full overflow-y-auto pb-4">
              ...
              <div className="col-span-2 flex items-center justify-center gap-2 w-full">
                <ArrhythmiaIndicator
                  isArrhythmia={isArrhythmia}
                  arrhythmiaStatus={vitalSigns.arrhythmiaStatus}
                  showDetails={true}
                  className="w-full py-3 px-4 bg-black/20 backdrop-blur-sm rounded-lg flex items-center justify-center"
                />
              </div>
            </div>
          </div>
