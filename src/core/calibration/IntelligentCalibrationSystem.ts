    ...
    try {
      ...
      const { error } = await supabase
        ...
        .upsert({
          ...
          is_active: true,
          heart_rate_reference: this.userProfile.referenceValues.heartRate,
          spo2_reference: this.userProfile.referenceValues.spo2,
          ...
          glucose_reference: this.userProfile.referenceValues.glucose,
